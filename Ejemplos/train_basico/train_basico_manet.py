...
model = CerebelumModelSegmentation("manet", "resnext50_32x4d", in_channels=3, out_classes=OUT_CLASSES)
...
log_dir = "/content/lightning_logs/version_3/events.out.tfevents.1748427825.29bf415aa1bd.20044.5"
...
process_word_document_for_report(
    ...
    model_name="MAnet"  # Nombre del modelo utilizado
)
