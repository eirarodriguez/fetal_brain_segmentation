...
model = CerebelumModelSegmentation("unet", "resnext50_32x4d", in_channels=3, out_classes=OUT_CLASSES)
...
log_dir = "/content/lightning_logs/version_0/events.out.tfevents.1748422055.29bf415aa1bd.566.1"
