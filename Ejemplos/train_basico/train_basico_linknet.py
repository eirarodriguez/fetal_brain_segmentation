...
train_dataset = Dataset(x_images_dir, y_masks_dir, train_ids)
valid_dataset = Dataset(x_images_dir, y_masks_dir, valid_ids)
test_dataset = Dataset(x_images_dir, y_masks_dir, test_ids)
...
model = CerebelumModelSegmentation("linknet", "resnext50_32x4d", in_channels=3, out_classes=OUT_CLASSES)
...
log_dir = "/content/lightning_logs/version_2/events.out.tfevents.1748426628.29bf415aa1bd.20044.3"
...
process_word_document_for_report(
    ...
    model_name="Linknet"  # Nombre del modelo utilizado
)
